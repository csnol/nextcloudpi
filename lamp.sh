...
install()
{
    ...
    wget -O /etc/apt/trusted.gpg.d/php.gpg https://origin.sury.org/php/apt.gpg
    echo "deb https://origin.sury.org/php/ ${RELEASE%-security} main" > /etc/apt/sources.list.d/php.list
    apt-get update
